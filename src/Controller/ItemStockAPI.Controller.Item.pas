...
procedure TCItem.BuscasAvancadas(aJSON: String);
begin
FModel.BuscasAvancadas(aJSON);
end;
...
function TCItem.ObterQuantidade: Integer;
begin
Result := FModel.ObterQuantidade;
end;

procedure TCItem.ObterTodos;
begin
 FModel.ObterTodos;
end;
